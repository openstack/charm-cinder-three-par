...
TEST_3PAR_CINDER_BACKEND = '{"cinder": {"/etc/cinder/cinder.conf": {"sections": {"charm-cinder-three-par": [["san_ip", "1.2.3.4"], ["san_login", "login"], ["san_password", "pwd"], ["hpe3par_username", ""], ["hpe3par_password", ""], ["hpe3par_api_url", "test.url"], ["hpe3par_cpg", ""], ["volume-backend-name", "charm-cinder-three-par"], ["volume_driver", "cinder.volume.drivers.hpe.hpe_3par_fc.HPE3PARFCDriver"]]}}}}'
...
class TestCharm(unittest.TestCase):
    ...
    def test_config_changed(self):
        ...
        print(rel.data[self.model.unit])
